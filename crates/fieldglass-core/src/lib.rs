...
pub use projection::{
    ...
    eastward_lon_span, expand_reduced_to_regular, gaussian_inverse, gaussian_latitudes,
    geostationary_inverse, is_octahedral_pl, lambert_azimuthal_forward, lambert_azimuthal_inverse,
    ...
    reduced_raster_lon_last, reduced_raster_width, rotate_latlon, rotated_latlon_point,

...
pub use projection::{
    ...
    PolarStereoParams, PolarStereoProjector, gaussian_inverse, gaussian_latitudes, lambert_forward,
    lambert_inverse, lambert_inverse_xy, latlon_inverse, polar_stereo_forward,

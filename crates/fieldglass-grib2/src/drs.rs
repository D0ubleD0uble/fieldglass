...
//! analogue. Other packing templates (complex 5.2, IEEE 5.4, JPEG 2000
//! 5.40, PNG 5.41, CCSDS 5.42) parse as
...
impl DataRepresentationSection {
    ...
    /// carries. Other (unsupported) templates return `None`.
    pub fn simple(&self) -> Option<&SimplePackingTemplate> {
        match &self.template {
            DataRepresentationTemplate::Simple(t) => Some(t),
            DataRepresentationTemplate::Unsupported(_) => None,
        }
    }
}

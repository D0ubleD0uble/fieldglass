...
//! `Grib2Reader::from_bytes` followed by `decode_message_values` for every
//! message it finds — asserting the parser never panics, over-reads, or hangs
//! on arbitrary input. The §5 DRS templates each carry their own

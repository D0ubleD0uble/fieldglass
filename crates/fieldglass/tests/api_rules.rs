...
const GEOREF_JSON: &str = r#"{"geometry":{"kind":"unsupported","label":"whatever"},"kind":"latlon","label":"latlon","ni":2,"nj":2,"boundsLonlat":[-1.0,1.0,-2.0,2.0],"proj4":"+proj=longlat","axisUnits":"degrees","x0":0.0,"y0":1.0,"dx":1.0,"dy":-1.0,"periodicX":false,"scan":{"iNegative":false,"jPositive":true,"jConsecutive":false}}"#;

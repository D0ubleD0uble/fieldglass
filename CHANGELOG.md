...
- **New Mollweide map projection for global fields.** The render panel's projection picker adds Mollweide, the equal-area elliptical world projection used in publications, alongside the existing equirectangular, Web Mercator, orthographic, and polar-stereographic targets. It takes a central-meridian control to recentre the map. Part of #242.

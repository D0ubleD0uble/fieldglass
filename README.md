...
| `crates/fieldglass` | The host-neutral API over the two GRIB readers: open bytes, decode a field, place it on the Earth, colour it. Every host is a binding of this one ([ADR-0006](docs/decisions/0006-hosts-are-bindings-over-a-plain-data-api.md)). |

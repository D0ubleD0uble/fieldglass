...
| Indicator / header section parsing | ✅ | $\color{red}{\textsf{Not yet}}$ | ✅ classic / 🚧 NetCDF-4 |
| Per-message metadata (parameter, level, time, forecast period) | ✅ | $\color{red}{\textsf{Not yet}}$ | ✅ classic (dims / vars / attrs) |
...
| Tabular metadata viewer | ✅ | $\color{red}{\textsf{Not yet}}$ | ✅ classic / 🚧 NetCDF-4 |
